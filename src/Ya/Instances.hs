...
deriving instance (Ord (f (Recursive f))) => Ord (Recursive f)
deriving instance (Ord l, Ord r) => Ord (l `P` r)
deriving instance (Ord l, Ord r) => Ord (l `S` r)
deriving instance (Ord l, Ord r) => Ord (T'I'II P l r)
deriving instance (Ord l, Ord r) => Ord (T'I'II S l r)
deriving instance (Ord l, Ord r) => Ord (T'II'I P r l)
deriving instance (Ord l, Ord r) => Ord (T'II'I S r l)
deriving instance (Ord (tt i (t ii)), Ord i, Ord ii) => Ord (TT'I'T'II t tt i ii)
deriving instance (Ord i) => Ord (Construction Optional i)
deriving instance (Ord i) => Ord (Tagged tag i)
